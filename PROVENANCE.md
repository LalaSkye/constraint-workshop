...
**Architecture layer:** Control primitives
**Licence:** Apache-2.0
...
**Public (this repository):** All primitives, tests, architecture diagrams, and API surfaces. CI/CD workflows.

**Private (withheld by design):** Composition and orchestration logic. Trinity gate internals. Production deployment configuration.
