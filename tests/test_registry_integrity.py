...
def test_missing_schema_version_raises(tmp_path):
    path = _write_json(tmp_path, {
        "transitions": [{"id": "T1", "irreversible": False, "risk_class": "LOW",
                         "required_authority": "USER", "gate_version": "v0.1"}]
    })
...
def test_duplicate_id_raises(tmp_path):
    path = _write_json(tmp_path, {
        "schema_version": "0.2",
        "transitions": [
            {"id": "T1", "irreversible": False, "risk_class": "LOW",
             "required_authority": "USER", "gate_version": "v0.1"},
            {"id": "T1", "irreversible": True, "risk_class": "HIGH",
             "required_authority": "ADMIN", "gate_version": "v0.1"},
        ]
    })
...
def test_invalid_risk_class_raises(tmp_path):
    path = _write_json(tmp_path, {
        "schema_version": "0.2",
        "transitions": [
            {"id": "T1", "irreversible": False, "risk_class": "EXTREME",
             "required_authority": "USER", "gate_version": "v0.1"}
        ]
    })
    with pytest.raises(ValueError, match="risk_class"):
...
def test_invalid_required_authority_raises(tmp_path):
    path = _write_json(tmp_path, {
        ...
        "transitions": [
            {"id": "T1", "irreversible": False, "risk_class": "LOW",
             "required_authority": "SUPERUSER", "gate_version": "v0.1"}
        ]
    })
    with pytest.raises(ValueError, match="required_authority"):
        load_registry(path)
...
def test_all_valid_required_authority_values_accepted(tmp_path, ra):
    path = _write_json(tmp_path, {
        ...
        "transitions": [
            {"id": "T1", "irreversible": False, "risk_class": "LOW",
             "required_authority": ra, "gate_version": "v0.1"}
        ]
    })
...
def test_all_valid_risk_class_values_accepted(tmp_path, rc):
    path = _write_json(tmp_path, {
        "schema_version": "0.2",
        "transitions": [
            {"id": "T1", "irreversible": False, "risk_class": rc,
             "required_authority": "USER", "gate_version": "v0.1"}
        ]
    })
    reg = load_registry(path)
